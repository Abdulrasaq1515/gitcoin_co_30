...
- [**Coalitional funding: a 2026+ era funding primitive** — Kevin Owocki & Griff Green](https://x.com/owocki/status/coalitional-funding)
- [**Protocol Guild** — Protocol Guild](https://protocol-guild.readthedocs.io/)
- [**The Linux Foundation** — Linux Foundation](https://www.linuxfoundation.org/)
- [**The Global Fund** — The Global Fund](https://www.theglobalfund.org/)
