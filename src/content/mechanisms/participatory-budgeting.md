...
shortDescription: "Community members propose and vote on how to allocate shared funds — shifting resource allocation authority from centralized decision-makers to the people impacted."
tags:
  - democratic
  - community
  - inclusive
...
1. **Community members submit proposals** for how shared funds should be spent
2. **Deliberation and review** — participants discuss, refine, and evaluate proposals collectively
3. **Voting** — the community votes using various mechanisms (one-person-one-vote, quadratic voting, STAR voting)
4. **Funds allocate** based on voting outcomes and budget limits
5. **Accountability** — funded projects report on execution and impact
...
- [Allo Capital — Participatory Budgeting](https://www.allo.capital/mechanisms/participatory-budgeting)
