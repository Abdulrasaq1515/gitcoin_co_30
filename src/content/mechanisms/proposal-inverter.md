---
id: '1741171224'
slug: proposal-inverter
name: "Proposal Inverter"
shortDescription: "Mechanism that inverts the traditional grant model — funders post needs and budgets, while builders choose which funded proposals to fulfill."
tags:
  - public goods
  - grants
  - coordination
...
1. **Funders identify needs** — organizations or DAOs articulate what they want built, researched, or delivered
2. **Funding is attached** — one or more funders commit capital to the proposal, pooling resources if multiple parties share the priority
3. **The proposal is published** — builders can browse funded proposals and assess which ones match their skills and interests
4. **Builders opt in** — teams or individuals claim proposals they're equipped to deliver
5. **Work is delivered and verified** — builders complete the work, and funders verify delivery
6. **Payment is released** — funds flow from the pooled proposal budget to the builder(s)
...
- [Proposal Inverter — Inverter Network](https://www.inverter.network/)
