...
slug: jokerace
name: "JokeRace"
shortDescription: "Onchain contest platform where communities submit and vote on entries — turning governance into competitive, incentivized contribution games."
tags:
  - governance
  - contests
  - DAOs
...
1. **A contest is created** — the organizer defines the prompt, voting rules, submission period, and rewards
2. **Entries are submitted** — participants submit onchain responses to the contest prompt
3. **Voting occurs** — designated voters (token holders, allowlisted addresses, etc.) vote on entries
4. **Winners are determined** — entries with the most votes win
5. **Rewards are distributed** — winners receive ETH, tokens, NFTs, or other rewards via smart contract
