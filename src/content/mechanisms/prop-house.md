...
slug: prop-house
name: "Prop House"
shortDescription: "Community-driven funding rounds where proposals compete for fixed allocations — pioneered by Nouns DAO for continuous, permissionless public goods funding."
tags:
  - public goods
  - grants
  - governance
...
1. **A community creates a round** — specifying the funding amount, number of winners, and voting rules
2. **Proposals are submitted** — anyone can submit a proposal describing what they'll build or create
3. **Community votes** — token holders or designated voters evaluate and vote on proposals
4. **Winners are selected** — the top-voted proposals receive equal shares of the funding pool
5. **Funds are distributed** — winners receive funding to execute their proposals
