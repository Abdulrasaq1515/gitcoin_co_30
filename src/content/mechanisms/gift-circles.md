...
slug: gift-circles
name: "Gift Circles"
shortDescription: "Participatory gatherings where community members distribute funding through dialogue, mutual recognition, and relational trust rather than voting or competition."
tags:
  - relational
  - participatory
  - trust
...
1. **Gather participants** — a group with shared context and mutual trust assembles (in-person or online)
2. **Pool resources** — a shared funding pool is established for the session
3. **Structured sharing rounds** — each participant shares their needs, contributions, and intentions with the group
4. **Collective gifting** — the group collectively decides how to distribute funds based on what was shared, often through consensus or facilitated dialogue
5. **Full transparency** — all allocation decisions are visible to the group
...
- [Allo Capital — Gift Circles](https://www.allo.capital/mechanisms/gift-circles)