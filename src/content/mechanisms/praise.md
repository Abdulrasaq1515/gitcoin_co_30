...
slug: praise
name: "Praise"
shortDescription: "Community recognition system where members acknowledge contributions through peer-to-peer praise — quantifying social value to inform reward distribution."
tags:
  - reputation
  - community
  - coordination
...
1. **Members praise each other** — using a simple command (typically in Discord), members describe what someone did and why it mattered
2. **Praise is recorded** — each instance is logged with the praiser, the praised, the description, and the date
3. **Quantification** — community members score praise instances to convert qualitative recognition into quantitative data
4. **Aggregation** — scores are compiled over a period to create contribution profiles
5. **Reward distribution** — aggregated praise scores inform token distributions, reputation updates, or other rewards
...
- [Praise — Token Engineering Commons](https://token-engineering-commons.gitbook.io/tec-handbook/tec-agreements-1/praise)
- [givepraise.xyz](https://givepraise.xyz)
