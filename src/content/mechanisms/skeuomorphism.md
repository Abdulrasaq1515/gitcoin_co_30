...
slug: skeuomorphism
name: "Skeuomorphism"
shortDescription: "Applying familiar coordination patterns from the physical or web2 world to web3 — reducing adoption barriers by mapping new mechanisms onto existing mental models."
tags:
  - design
  - coordination
  - adoption
...
1. **A novel coordination mechanism is identified** — a new way to allocate capital, make decisions, or organize
2. **A familiar analog is found** — an existing institution, process, or pattern that people already understand
3. **The new mechanism is framed using the familiar pattern** — language, interfaces, and workflows mirror the known analog
4. **Adoption barriers decrease** — participants engage with confidence because the pattern feels known
5. **The mechanism can evolve** — once adopted, the skeuomorphic framing can be gradually shed as users develop native understanding
