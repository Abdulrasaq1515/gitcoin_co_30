...
slug: bounties
name: "Bounties"
shortDescription: "Task-based funding where a funder defines work with clear deliverables and rewards, and contributors claim the bounty by completing it — minimal friction, maximum execution."
tags:
  - task-based
  - execution
  - open
...
1. **Define the task** — a funder specifies clear deliverables, scope, acceptance criteria, and reward amount
2. **Post the bounty** — published on forums, bounty platforms (Dework, Gitcoin), or via smart contracts
3. **Contributors claim and execute** — one or more contributors pick up the work and deliver results
4. **Review and accept** — a reviewer evaluates the submission against acceptance criteria
5. **Payment releases** — upon acceptance, the reward is released (optionally via smart contract escrow for trustless payment)
