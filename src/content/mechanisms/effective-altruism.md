...
shortDescription: "Evidence-based approach to maximizing positive impact per dollar spent — using rigorous analysis to identify the most cost-effective interventions for improving the world."
tags:
  - philanthropy
  - public goods
  - impact measurement
...
1. **Cause prioritization** — systematic evaluation of which problems are most important (scale, neglectedness, tractability)
2. **Intervention analysis** — rigorous comparison of specific interventions within priority causes using randomized controlled trials, cost-effectiveness analyses, and expected value calculations
3. **Resource allocation** — directing funding toward top-ranked interventions and organizations
4. **Impact measurement** — ongoing evaluation of whether interventions achieve predicted outcomes
5. **Iterative improvement** — updating beliefs and reallocating based on new evidence
