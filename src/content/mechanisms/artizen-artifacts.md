...
shortDescription: "Non-financial onchain tokens of recognition awarded for meaningful cultural and community contributions — collectible proofs of impact encoding symbolic value rather than financial worth."
tags:
  - recognition
  - cultural
  - nft
...
1. **Contributions are identified** — meaningful work in public goods, culture, art, or community is recognized
2. **Artifacts are curated** — a selection or curation process determines who receives recognition
3. **Onchain minting** — artifacts are minted as NFTs with embedded media, art, or poetic metadata
4. **Distribution** — artifacts are awarded at the end of funding rounds, community ceremonies, or milestone events
5. **Optional downstream effects** — artifacts may serve as access passes, eligibility criteria, or reputation signals for future opportunities
...
- [Allo Capital — Artizen Artifacts](https://www.allo.capital/mechanisms/artizen-artifacts)
- [Artizen](https://www.artizen.fund/)