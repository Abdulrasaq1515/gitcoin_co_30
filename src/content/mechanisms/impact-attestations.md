---
id: '1740500100005'
slug: impact-attestations
name: "Impact Attestations"
shortDescription: "Social or onchain signals that verify valuable contributions — functioning as a legitimacy layer that feeds into funding mechanisms like Retro Funding and Hypercerts."
tags:
  - reputation
  - verification
  - social
...
1. **Contributions are made** — a person or project delivers value to the ecosystem
2. **Attestations are issued** by peers, steward councils, smart contracts, or networks — vouching for the contribution's value
3. **Attestations accumulate** into reputational capital — onchain or offchain, transferable or soulbound, quantitative or qualitative
4. **Downstream mechanisms consume attestations** — retroactive funding rounds, registries, and grant programs use attestation data as input for allocation decisions
5. **Reputation compounds** over time, creating a track record that informs future funding
...
- [Allo Capital — Impact Attestations](https://www.allo.capital/mechanisms/impact-attestations)