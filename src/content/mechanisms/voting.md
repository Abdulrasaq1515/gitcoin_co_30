...
slug: voting
name: "Voting"
shortDescription: "Collective decision-making through preference expression — the foundational coordination mechanism for democratic governance, from Athenian assemblies to onchain governance."
tags:
  - ancient
  - governance
  - democratic
...
1. **An issue is framed** — a question, proposal, or set of candidates is presented
2. **Eligible participants express preferences** — through ballots, tokens, or other signals
3. **Votes are aggregated** — using a counting rule (plurality, majority, supermajority, etc.)
4. **An outcome is determined** — the winning option is identified and enacted
5. **The result is binding** — the community commits to the outcome
