---
id: '10'
slug: gitcoin-grants-24-gg24
name: Gitcoin Grants 24
shortDescription: "Gitcoin's inaugural Gitcoin 3.0 round distributed $1.8M across six domains using plural funding mechanisms."
tags:
  - gitcoin
  - quadratic funding
  - multi-mechanism
...
1. **Sensemaking (June–July 2025):** The community identified high-impact challenges across the Ethereum and public goods ecosystem, surfacing priority problem areas for funding.

2. **Domain selection (Late July 2025):** GTC holders voted to ratify five to six domains, each representing a distinct funding area with its own allocator team, budget, and mechanism design.

3. **Mechanism design (August–September 2025):** Domain allocators designed round-specific mechanisms — selecting from quadratic funding, deep funding, MACI private voting, conviction voting, retroactive funding, and peer-reviewed hypercerts — and recruited partners and co-funders.

4. **Synchronized donation rounds (October 14–28, 2025):** QF donation windows opened across multiple chains (Arbitrum, Celo, Ethereum). Applications had opened on October 2. Non-QF mechanisms (conviction voting, deep funding, retroactive evaluation) operated on domain-specific timelines.

5. **Outcome measurement and distribution (November 2025–Q2 2026):** QF results were reviewed November 5–10, with fund distribution by November 13. Several domains extended into 2026 with building phases, impact tracking, and retroactive reward distribution.
...
- [**GG24 Domains and Allocations** — Gitcoin Governance](https://gov.gitcoin.co/t/gg24-domains-and-allocations/24382)
- [**GG24 OSS Quadratic Funding Results** — Gitcoin Governance](https://gov.gitcoin.co/t/gg24-oss-quadratic-funding-results/24782)
- [**GG24 OSS QF on Giveth Retrospective** — Gitcoin Governance](https://gov.gitcoin.co/t/gg24-oss-qf-on-giveth-retrospective/24890)
- [**GG24 Privacy Round Retrospective** — Gitcoin Governance](https://gov.gitcoin.co/t/gg24-privacy-round-retrospective/24836)
- [**GG24 Interop Round Retrospective** — Gitcoin Governance](https://gov.gitcoin.co/t/gg24-interop-round-retrospective/24936)
- [**GG24 Solutions Development Grants Retrospective** — Gitcoin Governance](https://gov.gitcoin.co/t/gg24-solutions-development-grants-retrospective/24894)
- [**Deep Funding GG24 Web3 Tooling and Infra Round** — Gitcoin Governance](https://gov.gitcoin.co/t/deep-funding-gg24-web3-tooling-and-infra-round/25040)
- [**Gitcoin 3.0: The Road to GG24**](https://3.gitcoin.co/)
