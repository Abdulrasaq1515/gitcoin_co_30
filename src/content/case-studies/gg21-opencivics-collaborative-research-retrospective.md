---
id: '1741300000015'
slug: gg21-opencivics-collaborative-research-retrospective
name: "GG21 OpenCivics Collaborative Research Round Retrospective"
shortDescription: "The OpenCivics Collaborative Research Round 03 in GG21 distributed $38,750 USDC to 16 projects with lessons on cluster matching transparency, PayPal fiat integration, minimum matching thresholds, and the challenges of declining crowdfunding without an OSS anchor round."
tags:
  - gitcoin
  - quadratic-funding
  - grants
...
banner: /content-images/case-studies/gg21-opencivics-collaborative-research-retrospective/banner.png
---
...
> Your donation is a _weighted preference vote_ for which projects should be funded. In order to know how much you value a project, we need to understand your preferences in relationship to at least one other project. If you do find that your preferences are nearly 100% aligned with _only_ one project in the round, please make at least one other small donation to another project to ensure your primary donation is eligible for matching.
