---
id: '1749484808'
slug: exploring-the-capital-allocation-design-space
name: "How Should We Be Exploring the Capital Allocation Design Space?"
shortDescription: "Gitcoin's challenge of balancing depth vs breadth in capital allocation design — and why network-first exploration beats hierarchical approaches for frontier innovation."
tags:
  - capital allocation
  - mechanism design
  - governance
...
![Capital allocation design space](/content-images/research/exploring-the-capital-allocation-design-space/01-header.jpeg)
...
![The journey so far](/content-images/research/exploring-the-capital-allocation-design-space/02-journey.jpeg)
...
![Pluralistic design space](/content-images/research/exploring-the-capital-allocation-design-space/03-pluralistic-space.jpeg)
...
![Practical Pluralism](/content-images/research/exploring-the-capital-allocation-design-space/04-practical-pluralism.jpeg)

*[Practical Pluralism](https://medium.com/@owocki/practical-pluralism-322ab0a984c5) values diverse perspectives, methods, and ideologies.*
...
![Depth vs breadth](/content-images/research/exploring-the-capital-allocation-design-space/05-depth-vs-breadth.png)
...
![Network-first exploration](/content-images/research/exploring-the-capital-allocation-design-space/06-network-exploration.png)
...
![Hierarchy vs network](/content-images/research/exploring-the-capital-allocation-design-space/07-hierarchy-vs-network.png)
...
![Hybrid org-network structure](/content-images/research/exploring-the-capital-allocation-design-space/08-hybrid-structure.jpeg)
...
| **Protocol Fees & Token Locks** | Fees paid to Allo protocol, token locks from protocol usage |
| **Token Swaps** | Recognize that the next capital allocation tools will not be built at Grants Lab — enable other Allo builds through an "Allo Frontier Index Fund" |

![Organizational structure options](/content-images/research/exploring-the-capital-allocation-design-space/09-org-structure.png)

![Network structure approach](/content-images/research/exploring-the-capital-allocation-design-space/10-network-structure.png)
...
1. [Capturing Value like a Slime Mold](https://gov.gitcoin.co/t/capturing-value-like-a-slime-mold/17190)
2. [Systematic Exploration of the Coordination Mechanism Design Space](https://gov.gitcoin.co/t/systematic-exploration-of-the-coordination-mechanism-design-space/12616)
3. [AlloNets — A Powerful Approach to Manifesting Collective Action](https://gov.gitcoin.co/t/allonets-a-powerful-approach-to-manfesting-collective-action-in-an-onchain-world/19284)
4. [Shape Rotator's Guide to Funding What Matters](https://gov.gitcoin.co/t/shape-rotators-guide-to-funding-what-matters/17174)
