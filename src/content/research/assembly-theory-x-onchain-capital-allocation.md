...
name: "Assembly Theory x Onchain Capital Allocation"
shortDescription: "Assembly Theory explains how complexity emerges by combining simpler components — applied to Web3 funding infrastructure, it reveals a powerful approach to systematically exploring the capital allocation design space."
tags:
  - capital allocation
  - mechanism design
  - modularity
...
![Assembly Theory intro](/content-images/research/assembly-theory-x-onchain-capital-allocation/01-assembly-intro.jpeg)

### Assembly Theory: The Building Blocks of Complexity

[Assembly theory](https://www.nature.com/articles/s41586-023-06600-9) posits that complex systems emerge from simpler components combined through a series of steps. This framework can describe natural phenomena (like biological evolution), engineered systems (like blockchain protocols), and even conceptual systems like public goods funding mechanisms.

![Building blocks of complexity](/content-images/research/assembly-theory-x-onchain-capital-allocation/02-building-blocks.png)

Assembly theory is a corollary of [Gall's Law](https://en.wikipedia.org/wiki/John_Gall_(author)#Gall's_law) — which states that successful complex systems evolve from simple, functional ones, while complex systems designed from scratch often fail. It emphasizes starting with simplicity and iteratively building complexity to ensure adaptability and success.
...
![Purposeful evolution](/content-images/research/assembly-theory-x-onchain-capital-allocation/03-purposeful-evolution.png)
...
![Guided processes](/content-images/research/assembly-theory-x-onchain-capital-allocation/04-guided-processes.jpeg)
...
![Complexity index](/content-images/research/assembly-theory-x-onchain-capital-allocation/05-complexity-index.png)
...
![Web3 money legos](/content-images/research/assembly-theory-x-onchain-capital-allocation/06-web3-money-legos.png)
...
![Design space components](/content-images/research/assembly-theory-x-onchain-capital-allocation/07-design-space-components.png)

Another way is to map out the permutations of program design possibilities:

![Design space permutations](/content-images/research/assembly-theory-x-onchain-capital-allocation/08-design-space-permutations.png)
...
![Minecraft intro](/content-images/research/assembly-theory-x-onchain-capital-allocation/09-minecraft-intro.png)
...
![Minecraft creations](/content-images/research/assembly-theory-x-onchain-capital-allocation/10-minecraft-creations.jpeg)
...
![Minecraft landscape](/content-images/research/assembly-theory-x-onchain-capital-allocation/11-minecraft-landscape.jpeg)
...
1. **Create Accessible Building Blocks**: Simplify the process of combining mechanisms. Just as Minecraft makes placing blocks easy, Onchain Capital Allocation tools should offer intuitive, modular components.
2. **Foster a Fun, Profitable, and Social Environment**: Encourage collaboration, gamify experimentation, and celebrate contributions.
3. **Encourage Play, Discovery, & Iterative Improvement**: Provide environments where ideas can be tested, recombined, and improved, with clear feedback loops.
4. **Highlight Assembly Milestones**: Share examples of successful assemblies, showcasing how others have used the building blocks in creative ways.
