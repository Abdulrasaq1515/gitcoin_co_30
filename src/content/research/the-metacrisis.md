...
id: '1741171240'
slug: the-metacrisis
name: "The Metacrisis: Coordination Failure at Civilizational Scale"
shortDescription: "Humanity faces interconnected systemic crises — climate, AI, biodiversity, inequality — driven by the same generator functions: multipolar traps, perverse incentives, and coordination failure. The third attractor points toward distributed coordination as the way out."
tags:
  - coordination
  - public goods
  - governance
...
![Exponential technology: the blast radius of technology increases over time — from sticks and stones to guns to tanks to nukes to AI](/content-images/research/the-metacrisis/02-exponential-technology.png)
...
![The three attractors: catastrophes, dystopias, and the third attractor — mapped on axes of centralization/governance vs. how well we solve coordination failures](/content-images/research/the-metacrisis/01-three-attractors.png)
...
- [The Metacrisis with Daniel Schmachtenberger — Green Pill #26 (YouTube)](https://www.youtube.com/watch?v=WVEP0zAK-xQ)
- [Meditations on Moloch — Scott Alexander](https://slatestarcodex.com/2014/07/30/meditations-on-moloch/)
- [Metacrisis: An Overview — Jonah Wilberg](https://thewiderangle.substack.com/p/metacrisis-an-overview)
- [The Three Attractors — OpenCivics](https://broadcast.opencivics.co/p/thesis-chapter-6)
- [Daniel Schmachtenberger's Knowledge Graph — Stephen Reid](https://stephenreid.net/k/daniel/terms/metacrisis)
- [Bend Not Break: Modeling the Drivers of the Metacrisis — The Great Simplification](https://www.thegreatsimplification.com/episode/42-daniel-schmachtenberger)
