---
id: '1741190400003'
slug: microsolidarity-small-group-patterns-for-coordination
name: "Microsolidarity: Small-Group Patterns for Large-Scale Coordination"
shortDescription: "Richard Bartlett's microsolidarity framework offers a fractal organizational model — from dyads to congregations — that bridges the trust gap between individuals and large-scale coordination."
tags:
  - microsolidarity
  - coordination
  - community
...
*Richard Bartlett discussed microsolidarity and its applications to coordination on GreenPill (S4, Ep.15). For more on the framework, visit [microsolidarity.cc](https://www.microsolidarity.cc).*
