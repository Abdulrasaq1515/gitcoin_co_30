---
id: '1749484807'
slug: onchain-capital-allocation-neural-networks-allonets
name: "Onchain Capital Allocation Neural Networks (AlloNets)"
shortDescription: "Drawing lessons from neural networks to envision interconnected, adaptive onchain systems — AlloNets — that optimize capital distribution for public goods funding, collective action, and ecosystem growth."
tags:
  - capital allocation
  - mechanism design
  - neural networks
...
![AlloNets header](/content-images/research/onchain-capital-allocation-neural-networks-allonets/01-allonets-header.png)
...
![Biological neuron](/content-images/research/onchain-capital-allocation-neural-networks-allonets/02-biological-neuron.png)
...
![AI neuron](/content-images/research/onchain-capital-allocation-neural-networks-allonets/03-ai-neuron.jpeg)
...
![AI neural network layers](/content-images/research/onchain-capital-allocation-neural-networks-allonets/04-ai-layers.jpeg)
...
![Backpropagation and training](/content-images/research/onchain-capital-allocation-neural-networks-allonets/05-backpropagation.jpeg)
...
![Onchain neuron](/content-images/research/onchain-capital-allocation-neural-networks-allonets/06-onchain-neuron.png)
...
![AlloNet architecture](/content-images/research/onchain-capital-allocation-neural-networks-allonets/07-allonet-architecture.png)
...
![Retro Funding AlloNet](/content-images/research/onchain-capital-allocation-neural-networks-allonets/08-retro-funding-example.png)
...
![Ethereum ecosystem AlloNet](/content-images/research/onchain-capital-allocation-neural-networks-allonets/09-ethereum-allonet.png)
...
![Neuron types and allocation methods](/content-images/research/onchain-capital-allocation-neural-networks-allonets/10-neuron-types.png)
...
![AlloNet potential](/content-images/research/onchain-capital-allocation-neural-networks-allonets/11-allonet-potential.png)
