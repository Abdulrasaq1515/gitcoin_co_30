---
id: '1750051200'
slug: protocols-for-postcapitalist-expression
name: "Review & Recap: Protocols for Postcapitalist Expression"
shortDescription: "A review of the book that presents a programmable economic grammar where value is defined, expressed, and allocated by networks — not capital."
tags:
  - mechanism design
  - capital allocation
  - public goods
...
*Protocols for Postcapitalist Expression* is an ambitious and rigorously composed book that meets the moment. It doesn't just critique capitalism — it sketches a detailed architecture for what comes after, grounded in years of experimentation and intellectual heavy-lifting by the Economic Space Agency (ECSA). The authors — Dick Bryan, Jorge Lopez, and Akseli Virtanen — aren't offering a manifesto so much as a design protocol: a new grammar for expressing economic relationships based on shared values, not extractive logic.
...
![Assembly diagram 1](/content-images/research/protocols-for-postcapitalist-expression/02-assembly-diagram-1.png)

![Assembly diagram 2](/content-images/research/protocols-for-postcapitalist-expression/03-assembly-diagram-2.png)

![Assembly diagram 3](/content-images/research/protocols-for-postcapitalist-expression/04-assembly-diagram-3.png)

![Assembly diagram 4](/content-images/research/protocols-for-postcapitalist-expression/05-assembly-diagram-4.png)
...
### Tokens as Programmable Agreements
...
### Aspirations, Predictions, Evaluations
...
![Aspirations, predictions, and evaluations framework](/content-images/research/protocols-for-postcapitalist-expression/06-aspirations-predictions-evaluations.png)

## Conclusion

The book lands with clarity and complexity. It's theoretical but grounded, hopeful but not naive. And while some of its language can veer into abstraction, the implications are concrete. It suggests a world where communities can name what they value, stake on it, and allocate capital accordingly — without having to run everything through the reductive machinery of profit-maximization.
...
[Get the book here](https://www.amazon.com/Protocols-Postcapitalist-Expression-Dick-Bryan/dp/1570274142).
